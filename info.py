...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002061267081'))  # set shortner log channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002258152430')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002061267081'))
auth_channel = environ.get('AUTH_CHANNEL', '-1002322365518')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002098024797'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002098024797') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002322365518')) # 
...
PAYPICS = (environ.get('PAYPICS', 'https://cdn.jsdelivr.net/gh/Pavan844/Pavan844@main/share_image3568401614294045955.png')).split()
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://cdn.jsdelivr.net/gh/Pavan844/Pavan844@refs/heads/main/premium-gold-label_1017-7701.avif'))
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
